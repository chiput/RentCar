<?php
  $this->layout('layouts/main', [
    ...
    'submain_location' => 'Reservasi Checkin Kamar'
  ]);
...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <p class="text-muted m-b-30">Analisa Checkin</p>
    ...
    <div class="row">
            <div class="col-md-4">
                <div class="white-box">
                <h3 class="box-title">Laporan Checkin</h3>             
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Tanggal</th>
                        ...
                        <tbody>
                            ...
                            <tr colspan="2" width="50">
                                ...
                                <td>
                                    <?= $analisa->analisa_checkin($current_date)?>                                  
                                </td>
                            </tr>
                            <?php
                                    $dates[] = $current_date;
            ...
            <div class="col-md-8">
                <div class="white-box">
                    <h3 class="box-title">Checkin Date Grafik</h3>
                    <div>
