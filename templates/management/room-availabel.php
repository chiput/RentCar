<?php
  $this->layout('layouts/main', [
    ...
    'submain_location' => 'Ketersediaan Mobil'
  ]);
...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Ketersediaan Mobil</h3>
            <p class="text-muted m-b-30">Data Ketersediaan Mobil</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"> <span class="help"> Tipe Mobil</span></label>
                                    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                ?><h3 class="box-title">Tabel Ketersediaan Mobil</h3>
                    ...
                    <span style="text-align: right;float: right;">
                        <br>
                        <b>Total Mobil: </b><?php echo $total; ?>
        ...
        <div class="col-md-6">
          <div class="white-box">
              <h3 class="box-title">Chart Ketersediaan Mobil</h3>
