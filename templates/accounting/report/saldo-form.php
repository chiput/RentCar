...
<div class="row">
    <div class="col-sm-12">
      <div class="white-box">
        ...
        <h3 class="box-title m-b-0">Laporan Saldo</h3>
        <p class="text-muted m-b-20 font-13"> </p>
        <form class="form-horizontal" action="<?php echo $this->pathFor('accounting-report-saldo-print') ?>" method="POST" target="_blank">
