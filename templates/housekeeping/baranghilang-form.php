...
<form class="form-horizontal" action="<?php echo $this->pathFor('housekeeping-barang-save'); ?>" method="post">
<div class="row" id="housekeeping">
        <div class="white-box">
            <h3 class="box-title m-b-0">Form Barang Hilang</h3>
            ...
            <div class="row">
              ...
              <div class="form-group">
                  <label class="col-md-12" style="margin-bottom: 18px;"> <span class="help"> Tanggal</span></label>
                  <div class="col-md-12">
            ...
            <div class="form-group">
                <div class="col-md-12">
                  ...
                  <?php if (!isset($menus)): ?>
                    ...
                    <label for="aktif"> Belum Ditemukan</label>
                  <?php else: ?>
          ...
          <div class="form-group">
            ...
            <a class="btn btn-danger waves-effect waves-light m-r-10" href="<?=$this->pathFor('housekeeping-barang')?>">Batal</a>
            </div>
      </div>
    </div>
</div>
      ...
      <div class="modal-body">
        <table class="table datatable myDataTable">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="javascript:void(0)" data-guest-json='<?=$namakamar?>' onclick="getGuest(this); myFunction('<?=$namakamar->number?>');myFunctions('<?=@$namakamar->id?>')" data-toggle="tooltip" data-original-title="Pilih" data-dismiss="modal"><button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Pilih</button></a>
                    </td>
