...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Form Data Gudang Spa</h3>
            <p class="text-muted m-b-30">Menambah Data  Gudang Spa</p>

            <form class="form-horizontal" action="<?php echo $this->pathFor('gudangspa-save'); ?>" method="post" id='gudangForm'>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="gudang" class="form-control" onchange="ajaxgudang_get_id(this.value,'<?=$this->pathFor('gudangspa-ajax')?>');ajaxgudang_get_name(this.value,'<?=$this->pathFor('gudangspa-ajax')?>');">
                    ...
                    <a class="btn btn-danger waves-effect waves-light m-r-10" href="<?=$this->pathFor('gudangspa')?>">Batal</a>
                </div>
            </div>
        </form>
        </div>
