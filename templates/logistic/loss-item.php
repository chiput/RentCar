...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Barang Hilang / Rusak</h3>
            <p class="text-muted m-b-30">Data Barang Hilang / Rusak</p>          
            <form class="form" method="POST">
                <div class="row">
                    <div class="col-md-2">
                        <a href="javascript:void(0)" href="javascript:void(0)" data-toggle="modal" data-target="#warehouse-modal" class="btn btn-primary">Tambah Barang</a>
                    </div>
                    <div class="col-md-4">
                ...
                <?php foreach($items as $item){ ?>
                    <tr>
                        <td class="text-nowrap">
                            <a href="<?=$this->pathFor('logistic-loss-item-edit',["id"=>$item->id])?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i></a> 
                            <a href="<?=$this->pathFor('logistic-loss-item-delete',["id"=>$item->id])?>" data-toggle="tooltip" data-original-title="Hapus"> <i class="fa fa-close text-danger m-r-10"></i> </a> 
                            <a target="_blank" href="<?=$this->pathFor('logistic-loss-item-report',["id"=>$item->id])?>" data-toggle="tooltip" data-original-title="Cetak"> <i class="fa fa-print text-inverse m-r-10"></i> </a> 
                        </td>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="<?php echo $this->pathFor('logistic-loss-item-add') ?>">
                    <div class="row">
                        <div class="col-md-5">
