...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <p class="text-muted m-b-30">Tingkat Hunian</p>
        ...
        <div class="col-md-6">
            ...
            ?>
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php 
                            $total = 0;$check_in = 0;$occupancy = 0;
                            foreach ($z as $room): 
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            echo $roomnya;
                                            $occupancy = $occupancy + $roomnya;
                                            $check_in = $check_in + $strong;
                                            $total = $check_in + $occupancy;
                                        ?>
                                    </td>
                                </tr>
                         <?php 
                ...
                <span style="text-align: right;float: right;">
                    <br>
                    <b>Total Room: </b><?php echo $total; ?>
                    <b>Total Check in: </b><?php echo $check_in; ?>
                    <b>Total Occupancy: </b><?php echo $occupancy; ?>
                    <br>
                </span>
                <div class="clear"></div>
            </div>
        ...
        <div class="col-md-6">
          <div class="white-box">
              ...
              <ul class="list-inline m-t-30 text-center">
                ...
                <li>
                  <h5 class="text-muted"> <i class="fa fa-circle" style="color: #01c0c8;"></i> Occupancy</h5>
                  <h4 class="m-b-0"><?php echo $occupancy; ?></h4>
                </li>
            </ul>
          </div>
       </div>
...
<script type="text/javascript">
   Morris.Donut({
        ...
        data: [{
            ...
            label: "Occupancy",
            value: Math.round(<?=$occupancy/$total*100;?>),
        }],
        resize: true,
