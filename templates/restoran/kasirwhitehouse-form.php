...
<div class="row">
    <div class="col-sm-8">
        <div class="white-box">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo $this->pathFor('kasirwh-save'); ?>">
            <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                                ...
                                <div class="col-md-7" style="float: right; margin-right: -5px;">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7" style="float: right;">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" id="totaldiskon" name="totaldiskon" placeholder="Total Bayar" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <input type="number" id="totalharganya" name="totalnya" class="hidden" value="<?= @$reskasirku->total?>" />
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <a class="btn btn-danger waves-effect waves-light m-r-10" href="<?=$this->pathFor('kasirwh')?>">Batal</a>
                        </div>
                    </div>
                </div>
            <!-- </form> -->
