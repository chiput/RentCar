                               ...
                               <tr>
                                   <td>
                                    ...
                                    <?php if($nama){echo $nama;}else{echo "-";}?>
                                     ...
                                     <td>
                                    <select class='form-control' name='gudang_<?=$i;?>'  id='gudang_<?=$i;?>'>
                                    <option value="">Silakan Pilih</option>
                                    <?php
                                    $gudangid=@$menudetail->gudangid;
                ...
                <tr class="ppp">
                 ...
                 <?php foreach ($Barangs as $Barang) {
                   ?>
                    ...
                    <td><button type="button" class="btn btn-danger waves-effect waves-light" data-dismiss="modal" onclick="TambahrRow('<?=$Barang->kode;?>','<?=$Barang->nama;?>','<?=$Barang->brgsatuan_id;?>','<?=$Barang->hargajual;?>','<?=$Barang->id;?>','<?=$Barang->satuannama;?>')">Pilih</button></td>
                </tr>
...
function TambahrRow(kode,nama,satuan,hargabeli,id,namasatuan){
