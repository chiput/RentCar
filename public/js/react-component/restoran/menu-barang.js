var ModalAccount=React.createClass({
    ...
    findAccount:function(){
        ...
        var search=this.state.Menus.filter(function (acc) {
    ...
    componentDidMount:function(){
        ...
        var component=this;
            $.ajax({
                ...
                .done(function(data){
                    component.setState({Menus:data, displayed:data});
                });
    },
    render:function(){
        var component=this;
        var menu=this.state.displayed.map(function(data){
            //if(data.length>0){
        ...
        <div className={modalClass} tabIndex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style={{display: 'none'}}>
            ...
            <div className="modal-content">
              <div className="modal-header">
                ...
                <h4 className="modal-title" id="mySmallModalLabel">Daftar Barang</h4>
              </div>
              <div className="modal-body">
                <input type="text" ref="search" className="form-control" placeholder="Cari Barang" onChange={this.findAccount} />
